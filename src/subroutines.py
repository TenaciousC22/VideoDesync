...
def importSilence():
	clips=[]
	clips.append(AudioFileClip("../sound/bin/silence/060.wav"))
	clips.append(AudioFileClip("../sound/bin/silence/240.wav"))
	clips.append(AudioFileClip("../sound/bin/silence/360.wav"))
	return clips
